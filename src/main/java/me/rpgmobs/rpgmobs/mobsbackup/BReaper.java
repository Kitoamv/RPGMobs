...
public class BReaper implements Listener {
    ...
    public BReaper(RPGMobs plugin) {
        this.main = plugin;
    }

    public static void createBReaper(Location location) {
        Skeleton reaper = location.getWorld().spawn(location, Skeleton.class);
